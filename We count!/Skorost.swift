...
class Skorost: UIViewController,UIPickerViewDataSource,UIPickerViewDelegate {
  
    
let array = ["meter per second","foot per second","Kilometer per hour","Mile per hour"]
    let array1 = ["meter per second","foot per second","Kilometer per hour","Mile per hour"]
    ...
    @IBAction func Button(_ sender: Any) {
        ...
        if a == 1 && b == 1 {
            ...
            self.TextView.text = String(g! * 3.6)
        }else if a == 1 && b == 4{
            self.TextView.text = String(g! * 2.237)
        }else if a == 2 && b == 1{
            self.TextView.text = String(g! / 3.281)
            }else if a == 2 && b == 2{
                self.TextView.text = String(g!)
            }else if a == 2 && b == 3{
            self.TextView.text = String(g! * 1.097)
            }else if a == 2 && b == 4{
            self.TextView.text = String(g! * 1.467)
            }else if a == 3 && b == 1{
            self.TextView.text = String(g! / 3.6)
            }else if a == 3 && b == 2{
            self.TextView.text = String(g! / 1.097)
            ...
            self.TextView.text = String(g! / 1.609)
            }else if a == 4 && b == 1{
            self.TextView.text = String(g! / 2.237)
            }else if a == 4 && b == 2{
            self.TextView.text = String(g! * 1.467)
